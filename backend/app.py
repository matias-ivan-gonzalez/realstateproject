...
socketio = SocketIO()  # Configurar CORS y modo asíncrono
...
def create_app():
    ...
    # Registrar eventos de chat de forma modular para evitar importaciones circulares
    from chat_backend import register_chat_events
