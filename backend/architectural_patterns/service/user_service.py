...
class UserService:
    ...
    def get_calificaciones_editables_clientes_por_encargado(self, encargado_id):
        from datetime import date
        from architectural_patterns.repository.reserva_repository import ReservaRepository
        hoy = date.today()
        repo = ReservaRepository()
        return repo.get_reservas_calificaciones_editables_por_encargado(encargado_id, hoy) 